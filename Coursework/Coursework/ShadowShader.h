...
private:
	...
	ID3D11SamplerState* sampleState; // Sampler for texture
	ID3D11SamplerState* sampleStateShadow; // Sampler for shadow map
	ID3D11Buffer* lightBuffer; // Light Buffer to pass light variables
};
